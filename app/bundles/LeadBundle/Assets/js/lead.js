...
Mautic.addLeadListFilter = function (elId, elObj) {
    ...
    var isSpecial = (mQuery.inArray(fieldType, ['leadlist', 'assets', 'campaign', 'device_type',  'device_brand', 'device_os', 'lead_email_received', 'lead_email_sent', 'tags', 'multiselect', 'boolean', 'select', 'country', 'timezone', 'region', 'stage', 'locale', 'globalcategory']) != -1);
