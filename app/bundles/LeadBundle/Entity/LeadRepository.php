...
class LeadRepository extends CommonRepository implements CustomFieldRepositoryInterface
{
    ...
    public function updateLastActive($leadId)
    {
        ...
        $this->getEntityManager()->getConnection()->getConnection()->prepare("INSERT INTO ".MAUTIC_TABLE_PREFIX.'leads_last_active'." SET 
            last_active = :lastActive, 
            lead_id = :leadId 
            ON DUPLICATE KEY UPDATE
            last_active = :lastActive")
           ->bindValue("lastActive", $dt->toUtcString())
           ->bindValue("leadId", $leadId)
           ->execute();
    }
