...
class ListModel extends FormModel
{
    ...
    public function getChoiceFields()
    {
        ...
        $choices['lead'] = [
            ...
            'lead_asset_download' => ['label'      => $this->translator->trans('mautic.lead.list.filter.lead_asset_download'),
                'properties'                       => [
                    'type' => 'assets',
                ],
                'operators' => $this->getOperatorsForFieldType('multiselect'),
            ...
            'lead_email_sent_count' => [
                'label'      => $this->translator->trans('mautic.lead.list.filter.lead_email_sent_count'),
                'properties' => [
                    'type' => 'number',
                ],
                'operators' => $this->getOperatorsForFieldType(
